...
set std_lef [list \
  ...
  [file join $asap7_dir lef sram_asap7_256x128_1rw.lef] \
  [file join $asap7_dir lef sram_asap7_32x128_1rw.lef] \
  [file join $asap7_dir lef sram_asap7_32x256_1rw.lef] \
  [file join $asap7_dir lef sram_asap7_64x64_1rw.lef]
  ]
...
set lib_files [list \
  ...
  [file join $asap7_dir lib sram_asap7_256x128_1rw.lib] \
  [file join $asap7_dir lib sram_asap7_32x128_1rw.lib] \
  [file join $asap7_dir lib sram_asap7_32x256_1rw.lib] \
  [file join $asap7_dir lib sram_asap7_64x64_1rw.lib]
  ]
